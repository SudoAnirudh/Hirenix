      ...
      <div className="ml-auto flex items-center gap-6">
        ...
        {!fullscreenActive && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#7C9ADD]/10 border border-[#7C9ADD]/20 text-[#7C9ADD] text-[10px] font-bold uppercase tracking-widest hover:bg-[#7C9ADD]/20 transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C9ADD]/50"
          >
            <Expand size={12} />
            Secure Fullscreen
          </button>
