      ...
      <div className="flex items-center justify-between p-5 rounded-[28px] bg-slate-900 border border-slate-800 text-slate-200 shadow-xl max-w-4xl mx-auto w-full transition-all mt-4 select-none">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`p-3.5 rounded-full transition-all active:scale-90 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500 ${
              isListening
        ...
        <div className="flex items-center gap-3">
          {onExit && (
            <button
              type="button"
              onClick={onExit}
              className="p-3.5 rounded-full bg-slate-800 hover:bg-slate-700 text-red-400 border border-slate-700 transition-all active:scale-90 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500"
