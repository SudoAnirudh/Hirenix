          ...
          <div className="glass-card w-full max-w-xl p-10 rounded-[40px] bg-slate-900 border border-slate-800 shadow-2xl text-center">
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="px-10 py-4 rounded-[24px] bg-brand-blue hover:bg-blue-600 text-white font-display font-black shadow-2xl active:scale-[0.98] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
              >
                Restore Fullscreen
              </button>
            </div>
        ...
        <div className="flex items-center gap-3">
          ...
          {!isLast ? (
            <button
              ...
              disabled={submitting || transcribing}
              className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-brand-blue hover:bg-blue-600 text-white font-bold text-xs uppercase tracking-wider shadow-lg active:scale-95 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
            >
              <span>Next</span>
            ...
            <button
              ...
              disabled={submitting || transcribing}
              className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs uppercase tracking-wider shadow-lg active:scale-95 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
            >
