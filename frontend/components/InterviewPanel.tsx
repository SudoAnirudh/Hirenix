      ...
      <div className="flex items-center justify-between p-5 rounded-[28px] bg-slate-900 border border-slate-800 text-slate-200 shadow-xl max-w-4xl mx-auto w-full transition-all mt-4 select-none">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`p-3.5 rounded-full transition-all active:scale-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 ${
              isListening
