                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <label htmlFor="app-company" className="text-[10px] font-black uppercase tracking-widest text-[#64748B] ml-1">
                        Company
                      </label>
                    ...
                    <div className="space-y-2">
                      <label htmlFor="app-role" className="text-[10px] font-black uppercase tracking-widest text-[#64748B] ml-1">
                        Role
                      </label>
                      <div className="relative">
                        <Briefcase
                  ...
                  <div className="space-y-2">
                    <label htmlFor="app-location" className="text-[10px] font-black uppercase tracking-widest text-[#64748B] ml-1">
                      Location
                    </label>
                    <div className="relative">
                      <MapPin
                  ...
                  <div className="space-y-2">
                    <label htmlFor="app-link" className="text-[10px] font-black uppercase tracking-widest text-[#64748B] ml-1">
                      Job Link
                    </label>
                    <div className="relative">
                      <LinkIcon
