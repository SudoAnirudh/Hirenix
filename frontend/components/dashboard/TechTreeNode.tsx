        ...
        {skill.resources && skill.resources.length > 0 && (
          <div className="group/res relative">
            <button
              ...
              className="p-2 rounded-xl bg-white/40 border border-white transition-colors cursor-pointer text-slate-400 focus-visible:outline-none focus-visible:ring-2"
            >
