          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {plans.map(
              ({
                ...
                <div
                  key={id}
                  className="glass-card flex flex-col p-7 relative"
                  style={{
                    border: `1px solid ${highlight ? border : "var(--border)"}`,
                    boxShadow: highlight
                      ? `0 0 40px -8px ${accent}`
                      : undefined,
                  }}
                >
                  ...
                  <Link href={href}>
                    <button
                      className={`w-full py-2.5 rounded-lg font-semibold text-sm transition-all ${highlight ? "btn-primary" : "btn-ghost"}`}
                    >
                      {cta}
                    </button>
                  </Link>
