...
async def load_user_context(supabase_client: Client, user_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        resume_task = asyncio.to_thread(lambda: supabase_client.table("resumes") \
        ...
        github_task = asyncio.to_thread(lambda: supabase_client.table("github_analyses") \
        ...
        roadmap_task = asyncio.to_thread(lambda: supabase_client.table("roadmaps") \
        ...
        job_task = asyncio.to_thread(lambda: supabase_client.table("job_matches") \
        ...
        resume_res, github_res, roadmap_res, job_res = await asyncio.gather(resume_task, github_task, roadmap_task, job_task)
