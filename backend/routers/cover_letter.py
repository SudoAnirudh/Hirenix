...
async def generate_cover_letter(
    ...
    if payload.resume_id == "default":
        # Offload synchronous database call to a thread to prevent blocking the main event loop
...
async def export_cover_letter(
    ...
    # Fetch cover letter and profile data concurrently to reduce endpoint latency
